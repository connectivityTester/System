...
public class Action {
	...
	public Action(Command command, String commandType, List<Parameter> commandParametes, List<Action> thenBlock, List<Action> elseBlock, List<Action> loopBodyBlock, FailReaction failReaction, int retry) throws TestContextException {
